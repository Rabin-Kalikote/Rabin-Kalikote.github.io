        ...
        <div id="footer">
            <div class="container topCont">
                <div class="col-md-3">
                    <a class="Mr-link" onclick="document.getElementById('report').style.display='block'">REPORT ERROR</a>
                </div>
                <div class="col-md-3">
            ...
            <div class="report-error" id="report">
                <div class="report-content">
                    <span onclick="document.getElementById('report').style.display='none'" class="close">&times;</span>
                    <p class="report-title">Your Suggestions:</p>
                    <div class="report">
                        <form role="form" action="includes/report.php" method="post" autocomplete="off">
                            <div class="form-group input-group email">
                                <p class="centerd Mr-16">Your Email:</p>
                                <input type="text" required autocomplete="off" name='email' placeholder="Your Email">
                            </div>
                            <div class="form-group input-group address">
                                <p class="centerd Mr-16">Page Address:</p>
                                <input type="text" required autocomplete="off" name='address' placeholder="Page Address (copy the page link here)">
                            </div>
                            ...
                            <button type="submit" class="btn colored-btn" style="width:100%;margin:0 !important;"><i class="fa fa-3x fa-pencil-square-o"></i>&nbsp; Submit</button>
                        </form>
                    </div>
                </div>
            </div>
